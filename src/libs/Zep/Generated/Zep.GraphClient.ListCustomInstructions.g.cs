...
namespace Zep
{
    public partial class GraphClient
    {
        ...
        partial void PrepareListCustomInstructionsArguments(
            ...
            ref string? userId,
            ref string? graphId);
        partial void PrepareListCustomInstructionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? userId,
            string? graphId);
        partial void ProcessListCustomInstructionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListCustomInstructionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.ApidataListCustomInstructionsResponse> ListCustomInstructionsAsync(
            string? userId = default,
            string? graphId = default,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListCustomInstructionsAsResponseAsync(
                userId: userId,
                graphId: graphId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataListCustomInstructionsResponse>> ListCustomInstructionsAsResponseAsync(
            string? userId = default,
            string? graphId = default,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListCustomInstructionsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListCustomInstructionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListCustomInstructions",
                                methodName: "ListCustomInstructionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListCustomInstructionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListCustomInstructionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Zep.ApidataListCustomInstructionsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Zep.AutoSDKHttpResponse<global::Zep.ApidataListCustomInstructionsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Zep.ApidataListCustomInstructionsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
