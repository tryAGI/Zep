...
namespace Zep
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::Zep.GraphitiReranker?), TypeInfoPropertyName = "NullableGraphitiReranker2")]
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::Zep.GraphitiGraphSearchScope?), TypeInfoPropertyName = "NullableGraphitiGraphSearchScope2")]
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            public override bool CanConvert(global::System.Type typeToConvert)
            {
                return
                    ...
                    || typeToConvert == typeof(global::Zep.GraphitiReranker)

                    || typeToConvert == typeof(global::Zep.GraphitiReranker?)

                    || typeToConvert == typeof(global::Zep.GraphitiGraphSearchScope)
                ...
                global::System.Text.Json.JsonSerializerOptions options)
            {
                ...
                if (typeToConvert == typeof(global::Zep.GraphitiReranker))
                {
                    return new global::Zep.JsonConverters.GraphitiRerankerJsonConverter();
                }

                if (typeToConvert == typeof(global::Zep.GraphitiReranker?))
                {
                    return new global::Zep.JsonConverters.GraphitiRerankerNullableJsonConverter();
                }

                if (typeToConvert == typeof(global::Zep.GraphitiGraphSearchScope))
                {
                    return new global::Zep.JsonConverters.GraphitiGraphSearchScopeJsonConverter();
                }

                if (typeToConvert == typeof(global::Zep.GraphitiGraphSearchScope?))
                {
                    return new global::Zep.JsonConverters.GraphitiGraphSearchScopeNullableJsonConverter();
                }
