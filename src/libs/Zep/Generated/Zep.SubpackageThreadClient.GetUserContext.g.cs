...
namespace Zep
{
    public partial class SubpackageThreadClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_GetUserContextSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_GetUserContextSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_GetUserContextSecurityRequirement0,
            };
        partial void PrepareGetUserContextArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string threadId,
            ref string? templateId);
        partial void PrepareGetUserContextRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string threadId,
            string? templateId);
        partial void ProcessGetUserContextResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUserContextResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.ApidataThreadContextResponse> GetUserContextAsync(
            string threadId,
            string? templateId = default,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetUserContextAsResponseAsync(
                threadId: threadId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataThreadContextResponse>> GetUserContextAsResponseAsync(
            string threadId,
            string? templateId = default,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetUserContextArguments(
            ...
            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUserContextSecurityRequirements,
                operationName: "GetUserContextAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetUserContextAsync",
                                pathTemplate: "$\"/threads/{threadId}/context\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUserContextResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Zep.ApidataThreadContextResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Zep.AutoSDKHttpResponse<global::Zep.ApidataThreadContextResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Zep.ApidataThreadContextResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
