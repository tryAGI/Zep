...
namespace Zep
{
    public partial interface ISubpackageGraphClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataListCustomInstructionsResponse>> ListCustomInstructionsAsResponseAsync(
            string? userId = default,
            string? graphId = default,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
