...
namespace Zep
{
    public partial class SubpackageEntityClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_GetNodeSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_GetNodeSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_GetNodeSecurityRequirement0,
            };
        partial void PrepareGetNodeArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid);
        partial void PrepareGetNodeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid);
        partial void ProcessGetNodeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetNodeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.GraphitiEntityNode> GetNodeAsync(
            string uuid,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetNodeAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.GraphitiEntityNode>> GetNodeAsResponseAsync(
            string uuid,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetNodeSecurityRequirements,
                operationName: "GetNodeAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetNode",
                                methodName: "GetNodeAsync",
                                pathTemplate: "$\"/graph/node/{uuid}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Zep.GraphitiEntityNode.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Zep.AutoSDKHttpResponse<global::Zep.GraphitiEntityNode>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Zep.GraphitiEntityNode.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
