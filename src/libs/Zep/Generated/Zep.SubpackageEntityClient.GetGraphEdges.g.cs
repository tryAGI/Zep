...
namespace Zep
{
    public partial class SubpackageEntityClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_GetGraphEdgesSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_GetGraphEdgesSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_GetGraphEdgesSecurityRequirement0,
            };
        partial void PrepareGetGraphEdgesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string graphId,
            global::Zep.ApidataGraphEdgesRequest request);
        partial void PrepareGetGraphEdgesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string graphId,
            global::Zep.ApidataGraphEdgesRequest request);
        partial void ProcessGetGraphEdgesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetGraphEdgesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Zep.GraphitiEntityEdge>> GetGraphEdgesAsync(
            string graphId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetGraphEdgesSecurityRequirements,
                operationName: "GetGraphEdgesAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetGraphEdgesAsync",
                                pathTemplate: "$\"/graph/edge/graph/{graphId}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetGraphEdgesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GetGraphEdgesAsync(
                graphId: graphId,
                request: __request,
                requestOptions: requestOptions,
