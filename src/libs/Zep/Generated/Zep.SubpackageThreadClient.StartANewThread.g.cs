...
namespace Zep
{
    public partial class SubpackageThreadClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_StartANewThreadSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_StartANewThreadSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_StartANewThreadSecurityRequirement0,
            };
        partial void PrepareStartANewThreadArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Zep.ModelsCreateThreadRequest request);
        partial void PrepareStartANewThreadRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Zep.ModelsCreateThreadRequest request);
        partial void ProcessStartANewThreadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStartANewThreadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.ApidataThread> StartANewThreadAsync(

            global::Zep.ModelsCreateThreadRequest request,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await StartANewThreadAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataThread>> StartANewThreadAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareStartANewThreadArguments(
            ...
            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StartANewThreadSecurityRequirements,
                operationName: "StartANewThreadAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StartANewThread",
                                methodName: "StartANewThreadAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStartANewThreadResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessStartANewThreadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Zep.ApidataThread.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Zep.AutoSDKHttpResponse<global::Zep.ApidataThread>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Zep.ApidataThread.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await StartANewThreadAsync(
                request: __request,
                requestOptions: requestOptions,
