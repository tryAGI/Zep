...
namespace Zep
{
    public partial class SubpackageThreadClient
    {
        ...
        {
            var __response = await AddMessagesToAThreadInBatchAsResponseAsync(
                threadId: threadId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataAddThreadMessagesResponse>> AddMessagesToAThreadInBatchAsResponseAsync(
            string threadId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AddMessagesToAThreadInBatch",
                                methodName: "AddMessagesToAThreadInBatchAsync",
                                pathTemplate: "$\"/threads/{threadId}/messages-batch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
