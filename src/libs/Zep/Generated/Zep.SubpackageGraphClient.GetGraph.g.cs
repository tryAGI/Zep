...
namespace Zep
{
    public partial class SubpackageGraphClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_GetGraphSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_GetGraphSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_GetGraphSecurityRequirement0,
            };
        partial void PrepareGetGraphArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string graphId);
        partial void PrepareGetGraphRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string graphId);
        partial void ProcessGetGraphResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetGraphResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.ApidataGraph> GetGraphAsync(
            string graphId,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetGraphAsResponseAsync(
                graphId: graphId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataGraph>> GetGraphAsResponseAsync(
            string graphId,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetGraphSecurityRequirements,
                operationName: "GetGraphAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetGraphAsync",
                                pathTemplate: "$\"/graph/{graphId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetGraphResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Zep.ApidataGraph.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Zep.AutoSDKHttpResponse<global::Zep.ApidataGraph>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Zep.ApidataGraph.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
