...
namespace Zep
{
    public partial class GraphClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_UpdateEdgeSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_UpdateEdgeSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_UpdateEdgeSecurityRequirement0,
            };
        partial void PrepareUpdateEdgeArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string uuid,
            global::Zep.ApidataUpdateEdgeRequest request);
        partial void PrepareUpdateEdgeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string uuid,
            global::Zep.ApidataUpdateEdgeRequest request);
        partial void ProcessUpdateEdgeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateEdgeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.GraphitiEntityEdge> UpdateEdgeAsync(
            string uuid,
        ...
        {
            var __response = await UpdateEdgeAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.GraphitiEntityEdge>> UpdateEdgeAsResponseAsync(
            string uuid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateEdgeSecurityRequirements,
                operationName: "UpdateEdgeAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateEdgeAsync",
                                pathTemplate: "$\"/graph/edge/{uuid}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateEdgeResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Zep.GraphitiEntityEdge.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Zep.AutoSDKHttpResponse<global::Zep.GraphitiEntityEdge>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Zep.GraphitiEntityEdge.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
