...
namespace Zep
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Zep.AutoSDKRetryOptions Retry { get; set; } = new global::Zep.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Zep.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Zep.IAutoSDKHook>();
        ...
        public global::Zep.AutoSDKClientOptions AddHook(
            global::Zep.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Zep.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Zep.AutoSDKClientOptions UseAuthorizationProvider(
            global::Zep.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Zep.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Zep.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Zep.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Zep.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Zep.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Zep.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Zep.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Zep.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Zep.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Zep.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Zep.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Zep.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Zep.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Zep.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Zep.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Zep.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Zep.AutoSDKClientOptions clientOptions,
            global::Zep.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Zep.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Zep.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Zep.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Zep.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Zep.IAutoSDKHook, global::Zep.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Zep.AutoSDKHookContext context)
        {
