...
namespace Zep
{
    public partial class UserGroupClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_DetachPolicySetSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_DetachPolicySetSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_DetachPolicySetSecurityRequirement0,
            };
        partial void PrepareDetachPolicySetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string groupUUID,
            ref string policySetUUID,
            ref string projectId);
        partial void PrepareDetachPolicySetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string groupUUID,
            string policySetUUID,
            string projectId);
        partial void ProcessDetachPolicySetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDetachPolicySetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.ApidataAttachedPolicySetsResponse> DetachPolicySetAsync(
            string groupUUID,
            string policySetUUID,
            string projectId,
        ...
        {
            var __response = await DetachPolicySetAsResponseAsync(
                groupUUID: groupUUID,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataAttachedPolicySetsResponse>> DetachPolicySetAsResponseAsync(
            string groupUUID,
            string policySetUUID,
            string projectId,
            global::Zep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDetachPolicySetArguments(
                httpClient: HttpClient,
                groupUUID: ref groupUUID,
                policySetUUID: ref policySetUUID,
                projectId: ref projectId);


            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_DetachPolicySetSecurityRequirements,
                operationName: "DetachPolicySetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Zep.PathBuilder(
                                path: $"/abac/user-groups/{groupUUID}/policy-sets/{policySetUUID}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DetachPolicySet",
                                methodName: "DetachPolicySetAsync",
                                pathTemplate: "$\"/abac/user-groups/{groupUUID}/policy-sets/{policySetUUID}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDetachPolicySetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDetachPolicySetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
