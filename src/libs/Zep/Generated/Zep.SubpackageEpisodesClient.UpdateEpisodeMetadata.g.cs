...
namespace Zep
{
    public partial class SubpackageEpisodesClient
    {
        ...
        {
            var __response = await UpdateEpisodeMetadataAsResponseAsync(
                uuid: uuid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataGraphEpisode>> UpdateEpisodeMetadataAsResponseAsync(
            string uuid,
