...
namespace Zep
{
    public partial class GraphClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataDetectPatternsResponse>> DetectPatternsExperimentalAsResponseAsync(
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Zep.AutoSDKHttpResponse<global::Zep.ApidataDetectPatternsResponse>(
                                        statusCode: __response.StatusCode,
