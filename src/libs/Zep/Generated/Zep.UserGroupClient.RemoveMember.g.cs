...
namespace Zep
{
    public partial class UserGroupClient
    {
        ...
        private static readonly global::Zep.EndPointSecurityRequirement s_RemoveMemberSecurityRequirement0 =
        ...
        private static readonly global::Zep.EndPointSecurityRequirement[] s_RemoveMemberSecurityRequirements =
            new global::Zep.EndPointSecurityRequirement[]
            {                s_RemoveMemberSecurityRequirement0,
            };
        partial void PrepareRemoveMemberArguments(
        ...
        partial void ProcessRemoveMemberResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zep.ApidataUserGroupMembershipResponse> RemoveMemberAsync(
            string groupUUID,
            string userUUID,
            string projectId,
            string authorization,
        ...
        {
            var __response = await RemoveMemberAsResponseAsync(
                groupUUID: groupUUID,
                userUUID: userUUID,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zep.AutoSDKHttpResponse<global::Zep.ApidataUserGroupMembershipResponse>> RemoveMemberAsResponseAsync(
            string groupUUID,
            string userUUID,
            string projectId,
            string authorization,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Zep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveMemberSecurityRequirements,
                operationName: "RemoveMemberAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Zep.PathBuilder(
                                path: $"/user-groups/{groupUUID}/members/{userUUID}",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveMemberAsync",
                                pathTemplate: "$\"/user-groups/{groupUUID}/members/{userUUID}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Zep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveMemberResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
